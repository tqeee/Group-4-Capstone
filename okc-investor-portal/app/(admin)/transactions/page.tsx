...
// Per dataset 5.1, Admin is read-only for operational data: this is an
// oversight view of all fund-flow requests. Approvals happen in the
// operations role (/ops-transactions).
    ...
    <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-400 text-sm mt-1">
          Read-only oversight of all deposit and withdrawal requests. Reviews are performed by
          Operations.
        </p>
      </div>
