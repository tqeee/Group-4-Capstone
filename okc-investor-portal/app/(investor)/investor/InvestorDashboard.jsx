...
export default function InvestorDashboard({ email }) {
  ...
  return (
    <div className="space-y-6">
      {/* Greeting */}
      <div>
        <p className="text-gray-500 text-sm mb-1">Good morning, <b>{email ?? 'there'}</b>!</p>
      ...
      <div className="card p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            <p className="section-label mb-1">YOUR FUND</p>
