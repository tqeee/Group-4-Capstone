...
import { getFundDetails, getFundPerformance } from '../port-services/portfolioService';
...
export default function PerformancePage() {
  ...
  const rollingReturns = useMemo(() => {
    ...
    const buildPeriod = (period, targetStartDate) => {
      ...
      return {
        period: label,
        returnPercent: result.fundReturn,
        totalPnL: result.totalPnL,
        endingValue: result.portfolioValue,
      };
    };
