...
export default function PortfolioManagerDashboardClient({ funds, seriesByFund, pendingActions, recentActivity }) {
  ...
  const fundAllocationPct = fundDetails && totalAum > 0 ? (fundDetails.aum / totalAum) * 100 : 0;
              ...
              <div className="mt-8">
                <div className="flex items-end justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-400">Share of total AUM across all funds</p>
                  </div>
                  <p className="text-3xl font-bold text-blue-700">{fundAllocationPct.toFixed(0)}%</p>
                </div>
                <div className="mt-5 h-3 overflow-hidden rounded-full bg-gray-100">
                  <div className="h-full rounded-full bg-blue-700" style={{ width: `${fundAllocationPct}%` }} />
                </div>
