const statusStyles = {
  ...
  Validated: 'bg-emerald-100 text-emerald-800 ring-emerald-200 hover:bg-emerald-200 hover:shadow-emerald-100',
  Processing: 'bg-violet-100 text-violet-800 ring-violet-200 hover:bg-violet-200 hover:shadow-violet-100',
};
